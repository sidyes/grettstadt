    ...
    <main className="flex flex-col justify-between p-8 space-y-16">
      <section id="lage" className="container">
        ...
        <p className="text-base text-secondary leading-relaxed mb-paragraph">
          ...
          wichtigen Einrichtungen sind bequem zu Fuß erreichbar. Grundschule und
      ...
      <section id="erdgeschoss" className="container">
        ...
        <p className="text-base text-secondary leading-relaxed mb-paragraph">
          ...
          Essbereich erstreckt sich über 44 m² und ist mit einem zertifizierten
          Kaminofen ausgestattet. Die große Wohn-/Essküche bietet 22 m² Platz
          und hat einen direkten Zugang zur Terrasse. Ein 12 m² großes Büro
          steht ebenfalls zur Verfügung. Mit Ausnahme des Büros ist das gesamte
          Erdgeschoss mit Granitboden und Fußbodenheizung ausgestattet. Ein
          direkter Zugang von der isolierten Doppelgarage ins Haus sorgt dafür,
          dass man bei schlechtem Wetter trocken ins Haus gelangt. Die
          motorbetriebenen Garagentore und eine geflieste Garage mit Waschbecken
      ...
      <section id="obergeschoss" className="container">
        ...
        <p className="text-base text-secondary leading-relaxed mb-paragraph">
          ...
          ausgestattet ist und somit eine Küchenvorbereitung bietet – ideal für
          den Umbau in zwei unabhängige Einheiten. Ein Abstellraum mit
      ...
      <section id="untergeschoss" className="container">
        ...
        <p className="text-base text-secondary leading-relaxed mb-paragraph">
          ...
          Partyraum mit drei großen und freiliegenden Außenfenstern mit Rollos,
          sehr gut isoliert und beheizbar, steht ebenfalls zur Verfügung. Dieser
          Raum ist mit Wasser- und Starkstromanschluss ausgestattet. Ein
      ...
      <section id="aussenbereich" className="container">
        ...
        <p className="text-base text-secondary leading-relaxed mb-paragraph">
          ...
          bereit. Eine Zisterne mit einem Volumen von etwa 8 m³ sorgt für eine
          nachhaltige Gartenbewässerung. Ein geräumiges, achteckiges,
          individuell angefertigtes Gartenhaus dient als Mittelpunkt des Gartens
          und als Stauraum für Gartengeräte. Zwei Terrassen und zwei überdachte
